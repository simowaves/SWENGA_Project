...
public class TestDataController {
	...
	public String fillData(Model model) {
		...
		List<UserRoleModel> userRoles = userRoleRepository.findAll();

		if (users.isEmpty() && userRoles.isEmpty()) {
			...
			RecipeModel rec6 = new RecipeModel(now, now, "Penis", "Penis Penis Penis Penis", lukas, true, true,
					catSet6);
			...
			CommentModel com9 = new CommentModel("You can use this basic recepie and add what ever you want.", now,
					rec5, julian);
			commentRepository.save(com9);
			CommentModel com10 = new CommentModel("If it is good enough for me, it is good enough for everyone!", now,
					rec5, lukas);
